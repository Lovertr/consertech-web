...
export type Vehicle = {
  ...
  short: string;
  desc: string;
  image: string; // ภาพ mockup 3D โทนเทา (เรนเดอร์เอง — ไม่ติดลิขสิทธิ์)
  useCases: string[];
  specs: [string, string][];
};
...
export const vehicles: Vehicle[] = [
  {
    slug: "pallet-jack",
    image: "/images/vehicles/pallet-jack.jpg",
  ...
  {
    slug: "tugger-towing",
    image: "/images/vehicles/tugger-towing.jpg",
    name: "Tugger / Towing",
  ...
  },
  {
    ...
    image: "/images/vehicles/lifter-underride.jpg",
  ...
  },
  {
    ...
    image: "/images/vehicles/conveyor-roller.jpg",
  ...
  {
    slug: "unit-load",
    image: "/images/vehicles/unit-load.jpg",
    name: "Unit Load",
...
export const processSteps = [
  ...
  { n: 2, title: "ออกแบบ + คำนวณ", en: "Design", desc: "ออกแบบระบบและคำนวณตามหลักวิศวกรรม ให้ตรงกับหน้างานจริง" },
  { n: 3, title: "เสนอราคา + Scope", en: "Proposal", desc: "ใบเสนอราคาพร้อม Scope of Work ชัดเจนทุกรายการ" },
  { n: 4, title: "ทดสอบยอมรับ", en: "Acceptance Test", desc: "ทดสอบระบบร่วมกับลูกค้าตามเกณฑ์ที่ตกลงก่อนติดตั้งจริง" },
  { n: 5, title: "ติดตั้ง + ทดสอบ", en: "Install & Commissioning", desc: "ติดตั้งและทดสอบเดินระบบหน้างานโดยทีมวิศวกรของเรา" },
